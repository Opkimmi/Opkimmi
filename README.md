...
---
## 🔐 About Me
Cybersecurity student with a passion for breaking things (legally) and understanding how systems work under the hood. Currently serving as **CTF-responsible** for [Helt Sikker](https://heltsikker.no) — a student cybersecurity organization in Bergen, Norway.
## 🏆 CTF Achievements
| Competition | Team | Placement | Notes |
|-------------|------|-----------|-------|
| **Cybertalent 2025** (E-tjenesten) | Individual | 🥉 10/383 | Top 3% — 42/45 challenges (93.3%) |
